...
(function() {
	...
	myAjax.post(baseURL + '/api_cart', {
		...
		//点击结算按钮
		var oCalculate = document.querySelector('.checkoutBtn');
		oCalculate.onclick = function() {
			...
			window.location.href = 'storeshop.html';
		};
	});
	// 封装求总价的方法
	function getPriceAll() {
		...
		// 设置总价
		oPriceSum.innerHTML = '良品总价:' + '￥' + priceAll + '元';

		// span class = "priceNlo" > ￥ < font id = "show_price" > 0 < /font> </span>
	};
})();
